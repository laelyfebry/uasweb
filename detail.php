...
$sql = "SELECT * FROM tbl_obat LEFT JOIN tbl_dokter ON(tbl_obat.NID = tbl_dokter.NID)  WHERE Id_obat='$_GET[id]'";
                                    ...
                                    <div class="col-xl-12 col-lg-7">
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                <h6 class="m-0 font-weight-bold text-success">Daftar Obat Yang Di Ambil</h6>
                                            </div>
                                            <!-- Card Body -->
                                            <div class="card-body">
